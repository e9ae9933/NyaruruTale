...
public class KeyMap extends LinkedHashMap<Integer,Integer>
{
	...
	public void removeZXC()
	{
		removeAll(VK_Z,VK_X,VK_C);
	}
	public void removeZXCUDLR()
	{
		removeZXC();
		removeUDLR();
	}
	...
	public static void main(String[] args)
	{
		...
		Arrays.stream(keyEventClass.getDeclaredFields())
				.filter(f->f.getType()==int.class)
				.filter(f->f.getName().startsWith("VK_"))
				.forEach(
				f->{
		...
		Toolkit.getDefaultToolkit().getSystemClipboard().setContents(
				new StringSelection(joiner.toString()),
				null
		);
	}
}
