...
group = "io.github.e9ae9933.nyaruru"
...
tasks{
    compileJava{
        ...
        options.compilerArgs.add("java.base/jdk.internal.reflect=ALL-UNNAMED")
    }
    jar {
        manifest {
            attributes["Main-Class"]= "io.github.e9ae9933.nyaruru.aic.Test8"
        }
    }
}
